...
/*
 * Modifed by Sam Thompson ( SyntaxError90 ) for the phpBB Website Framework
 * Original: http://svn2.assembla.com/svn/phpbbmodders_lib/functions_cute_url.php
 */
...
class cute_url_handler
{
	...
	/**
	 * Gets the path pointing to base defiined in the constuctor for html hrefs and srcs
	 *
	 * @var string
	 */	
	public $web_root = './';
